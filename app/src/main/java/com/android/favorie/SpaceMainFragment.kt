...
class SpaceMainFragment : Fragment(R.layout.fragment_space_main),
    OnMusicClickListener {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val tvMusic = view.findViewById<TextView>(R.id.btn_by_space)
        ...
        // 초기 화면
        replaceChildFragment(MusicListFragment(), "SPACE")
        ...
        tvMood.setOnClickListener {
            ...
            replaceChildFragment(MusicMoodFragment(), "SPACE")
        }
    }
