...
class MusicMainFragment : Fragment(R.layout.fragment_music_main),
    OnMusicClickListener {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val tvMusic = view.findViewById<TextView>(R.id.btn_by_music)
        ...
        // 초기 화면
        replaceChildFragment(MusicListFragment(), "MUSIC")
        ...
        tvMood.setOnClickListener {
            ...
            replaceChildFragment(MusicMoodFragment(), "MUSIC")
        }
    }
