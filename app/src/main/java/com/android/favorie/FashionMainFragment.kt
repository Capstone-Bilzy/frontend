...
class FashionMainFragment : Fragment(R.layout.fragment_fashion_main),
    OnMusicClickListener {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val tvMusic = view.findViewById<TextView>(R.id.btn_by_fashion)
        ...
        // 초기 화면
        replaceChildFragment(MusicListFragment(), "FASHION")
        ...
        tvMood.setOnClickListener {
            ...
            replaceChildFragment(MusicMoodFragment(), "FASHION")
        }
    }
